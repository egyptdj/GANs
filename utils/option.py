...
def parse():
    ...
    parser.add_argument('-e', '--num_epoch', type=int, default=1000, help='total number of epochs to train')
    ...
    parser.add_argument('-tG', '--graph_type', type=str, default='gan', help='type of the GAN graph [gan]')
